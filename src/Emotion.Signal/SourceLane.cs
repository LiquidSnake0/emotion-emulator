...
///
/// « Quand le kick est en retrait pendant un moment, on est cense le savoir. » Une source
/// absente ne disparait pas de l'ecran : elle s'y montre eteinte, avec le temps qu'elle a
/// passe a se taire.
/// </param>
